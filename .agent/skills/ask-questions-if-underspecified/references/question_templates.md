...
_Reply with `1` to select the recommended option._
...
_Reply `defaults` to accept these, or specify changes._
...
_Which scope should I target?_
...
_Option 1 is better for sharing, Option 2 is simpler. Thoughts?_
