...
-   **Unnecessary Comments:** Delete comments that explain *what* code does (e.g. `// adds a to b`). Keep comments that explain *why*.
...
-   **SRP (The One Thing Rule):**
    ...
    -   *Litmus Test:* If you use "and" to describe it, split it.
