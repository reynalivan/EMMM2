...
async fn setup_pool() -> sqlx::SqlitePool {
    ...
    let migrations = [
        ...
        include_str!("../migrations/002_epic1_fixes.sql"),
        include_str!("../migrations/003_epic2_scanner.sql"),
        include_str!("../migrations/004_epic3_objects.sql"),
        include_str!("../migrations/005_epic4_explorer.sql"),
