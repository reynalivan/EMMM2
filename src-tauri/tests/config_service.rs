...
async fn test_games_persist_in_db() {
    ...
    settings.games.push(GameConfig {
        ...
        instance_path: PathBuf::from("C:\\Importer"),
        mod_path: PathBuf::from("C:\\Mods"),
        ready_to_move_path: None,
        launch_mode: emmm_lib::modules::games::api::testing::domain::models::LaunchMode::Standalone,
        game_exe: Some(PathBuf::from("C:\\Game\\game.exe")),
