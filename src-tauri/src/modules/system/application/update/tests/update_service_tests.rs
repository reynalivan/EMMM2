use crate::modules::system::application::update::asset_fetch::fetch_asset_if_missing;
use crate::modules::system::application::update::metadata_sync::check_and_sync_metadata;
use std::fs;
