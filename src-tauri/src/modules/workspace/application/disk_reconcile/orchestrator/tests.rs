...
fn applied_result(game_id: &str) -> crate::modules::workspace::application::disk_reconcile::types::DiskReconcileResult {
    crate::modules::workspace::application::disk_reconcile::types::DiskReconcileResult {
