...
pub struct DiskReconcileContext<'a> {
    ...
    pub config: &'a crate::modules::system::application::config::ConfigService,
...
impl DiskReconcileRequest {
    ...
    pub fn rename_resolutions(game_id: String, watcher_events: Vec<ModWatchEvent>) -> Self {
        let changed_paths =
            crate::modules::workspace::application::disk_reconcile::watcher_batch::collect_changed_paths(&watcher_events);
        Self {
            game_id,
