...
use crate::modules::workspace::application::disk_reconcile::disk_snapshot::collect_disk_projection;
...
struct WriterRun {
    ...
    change_summary: crate::modules::workspace::application::disk_reconcile::types::DiskReconcileChangeSummary,
}
