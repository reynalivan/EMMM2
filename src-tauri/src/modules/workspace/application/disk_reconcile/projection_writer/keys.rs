...
pub(super) fn root_key(root: &str) -> String {
    crate::shared::path_key::canonical_name_key(root)
}
...
pub(super) fn runtime_logical_path_key(folder_path: &str) -> String {
    crate::shared::path_key::folder_path_key(folder_path, None)
}

pub(super) fn is_runtime_prefix_transition(old_path: &str, new_path: &str) -> bool {
    crate::modules::collections::application::collection::classify_collection_path_transition(old_path, new_path)
        == crate::modules::collections::application::collection::CollectionPathTransitionKind::RuntimeTogglePrefix
}
