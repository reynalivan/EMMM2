...
use crate::modules::workspace::application::disk_reconcile::orchestrator::{
...
pub(crate) fn conflicts_intersect_paths(
    conflicts: &[crate::modules::workspace::application::disk_reconcile::types::FolderNameConflictGroup],
    paths: &[String],
) -> bool {
    paths.iter().any(|path| {
...
pub async fn run_full_internal_disk_reconcile_under_lease(
    ...
    pool: &sqlx::SqlitePool,
    game_id: &str,
    lease: &crate::modules::workspace::application::disk_reconcile::orchestrator::DiskMutationLease,
) -> Result<crate::modules::workspace::application::disk_reconcile::types::DiskReconcileResult, AppError> {
    let config = app
        .try_state::<crate::modules::system::application::config::ConfigService>()
        .ok_or_else(|| {
    ...
    crate::modules::workspace::application::disk_reconcile::orchestrator::reconcile_disk_state_under_lease(
...
pub fn start_initial_disk_recovery(
    ...
    state: &DiskReconcileState,
    game_id: &str,
) -> crate::modules::workspace::application::disk_reconcile::orchestrator::InitialRecoveryReadiness {
    use crate::modules::workspace::application::disk_reconcile::orchestrator::{
...
async fn run_internal_disk_reconcile_with_options(
    ...
    path_hints: Vec<crate::modules::workspace::application::disk_reconcile::orchestrator::DiskReconcilePathHint>,
) -> Result<crate::modules::workspace::application::disk_reconcile::types::DiskReconcileResult, AppError> {
    let config = app
        .try_state::<crate::modules::system::application::config::ConfigService>()
        .ok_or_else(|| {
...
pub async fn ensure_open_path_preflight(
    ...
    let census = tokio::task::spawn_blocking(move || {
        crate::modules::workspace::application::disk_reconcile::disk_snapshot::collect_disk_identity_census(&census_path)
    })
    .await?
    .map_err(|error| AppError::Io(error.into_message()))?;
    let conflicts = crate::modules::workspace::application::disk_reconcile::identity_conflicts::detect_folder_name_conflicts_from_census(
        game_id,
        &census,
    );
