...
use crate::modules::workspace::application::scanner::deep_matcher::analysis::ai_rerank::AiRerankProvider;
...
impl AiRerankProvider for HttpAiRerankProvider {
    fn rerank(
        &self,
        request: &crate::modules::workspace::application::scanner::deep_matcher::analysis::ai_rerank::AiRerankRequest,
