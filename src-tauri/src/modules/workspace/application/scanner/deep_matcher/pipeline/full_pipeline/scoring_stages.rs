...
use crate::modules::workspace::application::scanner::deep_matcher::pipeline::stages::entry_tokens;
use crate::modules::workspace::application::scanner::deep_matcher::state::master_db::MasterDb;
use crate::modules::workspace::application::scanner::deep_matcher::{Reason, ScoreState};
    ...
    for (entry_id, state) in states.iter_mut() {
        ...
        for skin in &entry.custom_skins {
            if let Some(alias) = skin.aliases.iter().find(|alias| {
                ...
                crate::modules::workspace::application::scanner::deep_matcher::analysis::scoring::apply_alias_contribution(
                    state, alias, 12.0,
                );
                break;
            }
