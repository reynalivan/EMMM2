...
use crate::modules::workspace::application::scanner::deep_matcher::analysis::indexes::MatcherIndexes;
...
use crate::modules::workspace::application::scanner::deep_matcher::ScoreState;
...
pub fn apply_direct_name_support_stage(
    ...
    for (entry_id, state) in states.iter_mut() {
        ...
        crate::modules::workspace::application::scanner::deep_matcher::analysis::scoring::apply_direct_name_support_contribution(
