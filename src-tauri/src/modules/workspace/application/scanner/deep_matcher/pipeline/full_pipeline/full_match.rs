...
use crate::modules::workspace::application::scanner::deep_matcher::analysis::ai_rerank::maybe_apply_ai_rerank;
use crate::modules::workspace::application::scanner::deep_matcher::analysis::content::PreparedTokenFilters;
use crate::modules::workspace::application::scanner::deep_matcher::analysis::gamebanana::{self, GameBananaConfig};
use crate::modules::workspace::application::scanner::deep_matcher::analysis::mechanical_rerank::{
    self, MechanicalRerankConfig,
};
use crate::modules::workspace::application::scanner::deep_matcher::models::acceptance::StageContext;
use crate::modules::workspace::application::scanner::deep_matcher::pipeline::name_rescue;
use crate::modules::workspace::application::scanner::deep_matcher::pipeline::stages::{
...
pub fn match_folder_full(
    ...
    ai_config: &crate::modules::workspace::application::scanner::deep_matcher::analysis::ai_rerank::AiRerankConfig<'_>,
    gb_config: &GameBananaConfig,
) -> StagedMatchResult {
    let mut local_cache =
        crate::modules::workspace::application::scanner::deep_matcher::state::signal_cache::SignalCache::new();
...
pub fn match_folder_full_cached(
    ...
    ai_config: &crate::modules::workspace::application::scanner::deep_matcher::analysis::ai_rerank::AiRerankConfig<'_>,
    gb_config: &GameBananaConfig,
    cache: &mut crate::modules::workspace::application::scanner::deep_matcher::state::signal_cache::SignalCache,
) -> StagedMatchResult {
    let signals = cache
        .get_or_compute(
            &candidate.path,
    ...
    crate::modules::workspace::application::scanner::deep_matcher::pipeline::stages::apply_alias_stage(
        db,
    ...
    crate::modules::workspace::application::scanner::deep_matcher::pipeline::stages::apply_deep_stage(
        db,
        &observed_buckets,
        &mut states,
    );
