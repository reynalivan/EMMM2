...
use crate::modules::workspace::application::scanner::deep_matcher::analysis::scoring::push_reason_capped;
...
pub fn apply_root_folder_rescue(db: &MasterDb, signals: &FolderSignals) -> StagedMatchResult {
    ...
    StagedMatchResult {
        ...
        candidates_all,
        evidence:
            crate::modules::workspace::application::scanner::deep_matcher::pipeline::quick_pipeline_result::empty_evidence(
                signals,
            ),
    }
}
