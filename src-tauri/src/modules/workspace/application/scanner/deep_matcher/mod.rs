...
pub fn match_folder_phased<'a>(
    ...
    ai_config: &crate::modules::workspace::application::scanner::deep_matcher::analysis::ai_rerank::AiRerankConfig<'a>,
) -> StagedMatchResult {
...
pub fn match_folder_phased_cached<'a>(
    ...
    pipeline::full_pipeline::match_folder_full_cached(
        ...
        ini_filters,
        ai_config,
        &crate::modules::workspace::application::scanner::deep_matcher::analysis::gamebanana::GameBananaConfig::default(),
        cache,
    )
}
