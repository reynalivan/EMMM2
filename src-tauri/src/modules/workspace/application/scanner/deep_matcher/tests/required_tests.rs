...
use crate::modules::workspace::application::scanner::deep_matcher::models::acceptance::{
    finalize_review, try_stage_accept, FinalizeConfig, StageAcceptConfig,
};
use crate::modules::workspace::application::scanner::deep_matcher::pipeline::stages::ObservedTokenBuckets;
...
use crate::modules::workspace::application::scanner::deep_matcher::{
    Confidence, CustomSkin, DbEntry, MatchMode, MatchStatus, Reason, ScoreState,
};
...
fn test_hash_normalization_via_extraction() {
    use crate::modules::workspace::application::scanner::deep_matcher::analysis::content::extract_hashes_from_ini_text;
        ...
        assert!(
            best.reasons
                ...
                .any(|r| matches!(r, Reason::DeepNameToken { .. })
                    ...
                    || matches!(r, Reason::SubstringName { .. })),
            "Expected deep/ini token or substring name reasons"
        );
    }
}
