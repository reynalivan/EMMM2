...
use crate::modules::workspace::application::scanner::deep_matcher::analysis::content::FULL_MAX_INI_FILES;

use super::match_folder_full;
use crate::modules::workspace::application::scanner::deep_matcher::state::master_db::MasterDb;
use crate::modules::workspace::application::scanner::deep_matcher::{CustomSkin, DbEntry, MatchStatus, Reason};
...
fn test_full_pipeline_fuzzy_rescue_never_auto_matches() {
    ...
    assert_eq!(
        best.confidence,
        crate::modules::workspace::application::scanner::deep_matcher::Confidence::Low
    );
    assert!(best
        .reasons
        .iter()
