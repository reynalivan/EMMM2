...
use crate::modules::workspace::application::scanner::deep_matcher::models::types::{
...
impl AiRerankProvider for CountingProvider {
    fn rerank(
        ...
        _db: &crate::modules::workspace::application::scanner::deep_matcher::MasterDb,
    ) -> Result<HashMap<usize, f32>, crate::shared::errors::ScannerError> {
...
fn signals(seed: &str) -> FolderSignals {
    FolderSignals {
        ...
        deep_name_strings: vec![format!("deep-{seed}")],
        folder_name_normalized: format!("folder-{seed}"),
        ini_derived_strings: vec![],
...
fn test_ai_rerank_disabled_does_not_call_provider() {
    ...
    let db = crate::modules::workspace::application::scanner::deep_matcher::MasterDb::new(vec![]);
