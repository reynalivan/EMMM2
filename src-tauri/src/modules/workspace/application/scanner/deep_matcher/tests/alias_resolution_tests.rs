...
use crate::modules::workspace::application::scanner::deep_matcher::{match_folder_phased, Confidence};
...
fn build_test_db() -> MasterDb {
    MasterDb::new(vec![
        ...
        DbEntry {
            ...
            aliases: vec!["pyro".to_string(), "polearm".to_string()],
            object_type: "Character".to_string(),
            entry_kind: Default::default(),
            custom_skins: vec![CustomSkin {
        ...
        DbEntry {
            ...
            aliases: vec!["anemo".to_string(), "sword".to_string()],
            object_type: "Character".to_string(),
            entry_kind: Default::default(),
            custom_skins: vec![
                CustomSkin {
        ...
        DbEntry {
            ...
            aliases: vec!["geo".to_string(), "sword".to_string()],
            object_type: "Character".to_string(),
            entry_kind: Default::default(),
            custom_skins: vec![
                CustomSkin {
