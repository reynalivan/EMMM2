...
use crate::modules::workspace::application::workspace_read_model::preview_builder::{
...
pub async fn get_workspace_view_model_with_listing_mode(
    ...
    let root_listing = if shallow_listing {
        crate::modules::workspace::application::explorer::listing::list_mod_folders_for_game_shallow(
            pool,
            &game_id,
            mods_path.clone(),
            None,
