...
pub struct CollectionRuntimeSnapshot {
    ...
    pub missing_count: usize,
    pub last_changes: Option<LastChangesSnapshot>,
    pub current_mods: Vec<crate::modules::collections::domain::collection::CollectionMod>,
    pub current_objects: Vec<crate::modules::collections::domain::collection::CollectionObject>,
    pub current_tree_nodes: Vec<crate::modules::collections::domain::collection::PreviewTreeNode>,
    pub projected_state: crate::modules::collections::domain::collection::ProjectedCollectionState,
}
