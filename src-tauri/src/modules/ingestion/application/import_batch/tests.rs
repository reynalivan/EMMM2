...
async fn classification_requires_awaiting_category_and_keeps_user_metadata_authoritative() {
    ...
    assert!(crate::modules::ingestion::adapters::outbound::sqlite::import_batch::transition_item_status(
        &context.pool,
        item_id,
...
async fn processed_mod_inbox_groups_pack_children_under_one_source_history() {
    ...
    crate::modules::ingestion::adapters::outbound::sqlite::import_batch::create_batch(
        &context.pool,
        &crate::modules::ingestion::adapters::outbound::sqlite::import_batch::CreateImportBatchRecord {
        ...
        &[crate::modules::ingestion::adapters::outbound::sqlite::import_batch::NewImportItemRecord {
    ...
    .await
    .unwrap();
    crate::modules::ingestion::adapters::outbound::sqlite::import_batch::replace_archive_item_with_roots(
        &context.pool,
        "source-pack-history",
        &[
            crate::modules::ingestion::adapters::outbound::sqlite::import_batch::StagedRootRecord {
    ...
    .await
    .unwrap();
    crate::modules::ingestion::adapters::outbound::sqlite::import_batch::mark_mod_inbox_source_processed(
        &context.pool,
        "batch-pack-history",
