use crate::modules::updates::application::update::asset_fetch::fetch_asset_if_missing;
use crate::modules::updates::application::update::metadata_sync::check_and_sync_metadata;
use std::fs;
