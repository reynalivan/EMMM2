...
use crate::modules::matching::application::deep_matcher::pipeline::quick_pipeline_result::{
...
pub struct StageContext<'a> {
    ...
    pub buckets: &'a crate::modules::matching::application::deep_matcher::pipeline::stages::ObservedTokenBuckets,
    pub mode: MatchMode,
    pub review_min_score: f32,
    pub top_k: usize,
}
...
pub fn try_stage_accept(
    ...
    observed_buckets: &crate::modules::matching::application::deep_matcher::pipeline::stages::ObservedTokenBuckets,
    ...
    let foreign_hits = candidates
        ...
        .and_then(|c| {
            c.reasons.iter().find_map(|r| {
                if let crate::modules::matching::application::deep_matcher::Reason::NegativeEvidence {
                    foreign_strong_hits,
                } = r
                {
