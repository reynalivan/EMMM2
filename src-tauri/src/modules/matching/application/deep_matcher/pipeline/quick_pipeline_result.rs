...
use crate::modules::matching::application::deep_matcher::analysis::scoring::cap_evidence;
...
pub(crate) fn build_evidence(
    db: &MasterDb,
    signals: &crate::modules::matching::application::deep_matcher::analysis::content::FolderSignals,
    best: &Candidate,
) -> Evidence {
