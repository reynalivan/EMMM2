...
use crate::modules::matching::application::deep_matcher::models::acceptance::StageContext;
...
pub fn match_folder_quick_cached(
    ...
    ini_filters: &PreparedTokenFilters,
    ai_config: &crate::modules::matching::application::deep_matcher::analysis::ai_rerank::AiRerankConfig<'_>,
    cache: &mut crate::modules::matching::application::deep_matcher::state::signal_cache::SignalCache,
) -> StagedMatchResult {
    let signals = cache
    ...
    crate::modules::matching::application::deep_matcher::pipeline::stages::apply_alias_stage(
        db,
    ...
    crate::modules::matching::application::deep_matcher::pipeline::stages::apply_deep_stage(
        db,
        &observed_buckets,
        &mut states,
    );
