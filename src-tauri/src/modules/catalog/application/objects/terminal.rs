...
use crate::modules::catalog::adapters::outbound::sqlite::object::{ObjectCountCandidate, TerminalDescriptor};
...
pub(crate) fn build_terminal_counts(
    ...
    for candidate in candidates {
        ...
        match candidate.safety_source.as_deref() {
            Some(source) if source != crate::shared::safety_constants::SAFETY_SOURCE_UNKNOWN => {
