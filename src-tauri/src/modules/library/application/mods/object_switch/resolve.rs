...
async fn heal_object_root_path(
    ...
    crate::modules::catalog::adapters::outbound::sqlite::object::update_object_runtime_folder_path(
        pool,
        game_id,
        old_folder_path,
        new_folder_path,
    ...
    crate::modules::library::adapters::outbound::sqlite::mods::update_child_paths(
        pool,
        game_id,
        old_folder_path,
        new_folder_path,
