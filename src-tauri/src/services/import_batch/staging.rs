...
async fn stage_ready_to_move_folder(
    ...
    let records = tokio::task::spawn_blocking(move || {
        let mut roots =
            crate::services::mods::archive::classify::find_mod_roots(&source_for_worker, 5);
        roots.sort();
        ...
        roots
            ...
            .map(|(index, root)| {
                ...
                Ok(StagedRootRecord {
                    ...
                    planned_name: crate::services::mods::core_ops::standardize_prefix(
                        &root_name, false,
                    ),
                })
            })
...
async fn stage_archive_item(
    ...
    let staged = tokio::task::spawn_blocking(move || {
        crate::services::mods::archive::extract_archive_to_staging(&archive, &extract_for_worker)
    })
    .await??;
