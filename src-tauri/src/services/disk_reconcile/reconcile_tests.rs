...
use crate::services::disk_reconcile::reconcile::ReconcileOutcome;
...
async fn offline_semantic_rename_without_identity_requires_confirmation_and_keeps_db_snapshot() {
    ...
    let resolution_event = crate::services::scanner::watcher::ModWatchEvent::RenameResolution {
...
async fn watcher_rename_event_is_sufficient_evidence_when_filesystem_identity_is_missing() {
    ...
    let event = crate::services::scanner::watcher::ModWatchEvent::Renamed {
