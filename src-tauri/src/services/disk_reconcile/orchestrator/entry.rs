...
use crate::services::scanner::watcher::{ModWatchEvent, WatcherSession};
...
async fn run_reconcile_with_owned_locks(
    ...
    let may_reuse_activation_scan = request.force_full
        ...
        && matches!(
            request.reason,
            crate::services::disk_reconcile::types::DiskReconcileReason::ModsViewEntered
                | crate::services::disk_reconcile::types::DiskReconcileReason::GameSwitched
        )
