...
use crate::services::scanner::watcher::{ModWatchEvent, WatcherSession, WatcherSuppressor};
...
pub struct DiskReconcileContext<'a> {
    ...
    pub operation_lock: &'a crate::services::fs_utils::operation_lock::OperationLock,
...
impl DiskReconcileRequest {
    ...
    pub fn rename_resolutions(game_id: String, watcher_events: Vec<ModWatchEvent>) -> Self {
        let changed_paths =
            crate::services::disk_reconcile::watcher_batch::collect_changed_paths(&watcher_events);
        Self {
            game_id,
