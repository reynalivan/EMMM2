use crate::services::scanner::walker::{self, ModCandidate};
...
use dedup_scanner_signals::{aggregate_signals, collect_snapshot, hash_snapshot, ModSnapshot};
