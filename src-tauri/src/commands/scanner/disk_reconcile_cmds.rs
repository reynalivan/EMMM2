...
) -> Result<crate::services::disk_reconcile::source_recovery::GameModsDirectoryInspection, AppError>
{
    crate::services::disk_reconcile::source_recovery::inspect_game_mods_directory(
        pool.inner(),
        &game_id,
...
pub async fn apply_game_mods_directory(
    request: crate::services::disk_reconcile::source_recovery::ApplyGameModsDirectoryRequest,
    pool: State<'_, sqlx::SqlitePool>,
    ...
    >,
    operation_lock: State<'_, crate::services::fs_utils::operation_lock::OperationLock>,
) -> Result<crate::services::disk_reconcile::source_recovery::ApplyGameModsDirectoryResult, AppError>
{
    ...
    let result = crate::services::disk_reconcile::source_recovery::apply_game_mods_directory(
    ...
    *crate::common::sync::lock(&watcher.watcher) = None;
...
pub async fn reconcile_disk_state_cmd(
    ...
    if should_wait_for_initial_recovery(
        ...
        return match crate::services::disk_reconcile::emit::ensure_initial_disk_recovery(
            &app,
            pool.inner(),
...
pub async fn resolve_rename_confirmations(
    game_id: String,
    resolutions: Vec<crate::services::disk_reconcile::types::RenameConfirmationResolution>,
    pool: State<'_, sqlx::SqlitePool>,
    config: State<'_, crate::services::config::ConfigService>,
    watcher: State<'_, crate::services::scanner::watcher::WatcherState>,
    disk_reconcile_state: State<
    ...
    let events = resolutions
        ...
        .map(|resolution| {
            let apply_as_rename = matches!(
                resolution.action,
                crate::services::disk_reconcile::types::RenameConfirmationResolutionAction::Rename
            );
            ...
            Ok(
                crate::services::scanner::watcher::ModWatchEvent::RenameResolution {
    ...
    crate::services::disk_reconcile::orchestrator::reconcile_disk_state(
        ...
        crate::services::disk_reconcile::orchestrator::DiskReconcileRequest::rename_resolutions(
            game_id, events,
        ),
    )
    .await
