use super::find_disabled_ancestor;
...
fn test_find_disabled_ancestor_none_for_clean_path() {
    assert_eq!(find_disabled_ancestor("Characters/Kaeya"), None);
    assert_eq!(find_disabled_ancestor("Characters/Kaeya/Outfit"), None);
}

#[test]
fn test_find_disabled_ancestor_root_empty() {
    assert_eq!(find_disabled_ancestor(""), None);
}
...
fn test_find_disabled_ancestor_single_level() {
    // Both slash styles
    assert_eq!(
        find_disabled_ancestor("DISABLED Characters/Kaeya"),
...
fn test_find_disabled_ancestor_multi_level_returns_outermost() {
    ...
    assert_eq!(
        find_disabled_ancestor("DISABLED A/B/DISABLED C/D"),
        Some("A".to_string())
    );
}
...
fn test_find_disabled_ancestor_only_last_segment_disabled() {
    ...
    assert_eq!(
        find_disabled_ancestor("A/B/DISABLED C"),
        Some("C".to_string())
    );
}
