...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::mods::mod_bulk_cmds::bulk_toggle_mods_by_ids,
            ...
            commands::app::settings_cmds::set_safe_mode_pin_with_recovery,
            ...
            commands::app::settings_cmds::preview_corridor_switch,
