...
pub async fn store_inspection(
    db: &SqlitePool,
    item_id: &str,
    inspection: &crate::services::match_engine::types::SourceInspection,
...
pub async fn get_stored_inspection(
    db: &SqlitePool,
    item_id: &str,
) -> Result<Option<crate::services::match_engine::types::SourceInspection>, sqlx::Error> {
...
pub async fn store_classification(
    db: &SqlitePool,
    input: &crate::services::import_batch::types::SetImportItemClassificationInput,
) -> Result<bool, sqlx::Error> {
...
pub async fn store_decision(
    db: &SqlitePool,
    input: &crate::services::import_batch::types::SetImportItemDecisionInput,
) -> Result<bool, sqlx::Error> {
