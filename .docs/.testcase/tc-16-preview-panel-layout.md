...
**Requirement File**:`e:\Dev\EMMMNEW\.docs\requirements\req-16-preview-panel-layout.md`
...
- **Preconditions**: OS: Windows 10/11. App: EMMM dev build. ObjectList instantiated tracking Object counts. Grid rendering >= 10 mod objects.
- **Context Injection**:
