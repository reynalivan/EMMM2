...
- **Main Risks**: identity migration fails after`fs::rename` succeeds → covered by the post-move scoped Disk Reconcile (source + target roots) re-deriving the row; file already moved externally between lock acquisition and rename attempt.
...
| :------------------------------------ | :---------------- | :----------------------------------------------------------- |
| AC-38.1.1 (Move to hierarchy)         | TC-38-001         | `e:\Dev\EMMMNEW\.docs\requirements\req-38-auto-organizer.md` |
| AC-38.1.2 (Atomic DB update)          | TC-38-002         | `e:\Dev\EMMMNEW\.docs\requirements\req-38-auto-organizer.md` |
| AC-38.1.3 (Toast + single invalidate) | TC-38-003         | `e:\Dev\EMMMNEW\.docs\requirements\req-38-auto-organizer.md` |
| AC-38.1.4 (Duplicate skip)            | TC-38-004         | `e:\Dev\EMMMNEW\.docs\requirements\req-38-auto-organizer.md` |
| AC-38.1.5 (Uncategorized skip)        | TC-38-005         | `e:\Dev\EMMMNEW\.docs\requirements\req-38-auto-organizer.md` |
| AC-38.1.6 (Enabled mod move)          | TC-38-006         | `e:\Dev\EMMMNEW\.docs\requirements\req-38-auto-organizer.md` |
| Implied: 100-folder perf bound        | TC-38-007         | `e:\Dev\EMMMNEW\.docs\requirements\req-38-auto-organizer.md` |
| Implied: Path escape prevention       | TC-38-008         | `e:\Dev\EMMMNEW\.docs\requirements\req-38-auto-organizer.md` |
...
- **DB State**:`emmm.db` with at least 3 mod folders indexed (`object_id` resolved by Deep Matcher)
- **Filesystem State**:
