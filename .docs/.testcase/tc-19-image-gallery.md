...
- **Success Criteria**: -`list_mod_preview_images` in ≤ 100ms.
...
**Requirement File**:`e:\Dev\EMMMNEW\.docs\requirements\req-19-image-gallery.md`
...
- **Preconditions**: OS: Windows 10/11. App: EMMM dev build. Custom protocol`emmm://` registered internally returning images physically.
- **Context Injection**:
