...
| :----------------------------------------------- | :---------------- | :------------------------------------------------------------- |
| AC-39.1.1 (Dialog open ≤ 300ms)                  | TC-39-001         | `e:\Dev\EMMMNEW\.docs\requirements\req-39-folder-collision.md` |
| AC-39.1.2 (Side-by-side data)                    | TC-39-002         | `e:\Dev\EMMMNEW\.docs\requirements\req-39-folder-collision.md` |
| AC-39.1.3 (No INI fallback display)              | TC-39-003         | `e:\Dev\EMMMNEW\.docs\requirements\req-39-folder-collision.md` |
| AC-39.2.1 (Keep Enabled strategy)                | TC-39-004         | `e:\Dev\EMMMNEW\.docs\requirements\req-39-folder-collision.md` |
| AC-39.2.2 (Keep Both strategy)                   | TC-39-005         | `e:\Dev\EMMMNEW\.docs\requirements\req-39-folder-collision.md` |
| AC-39.2.3 (Replace With Incoming)                | TC-39-006         | `e:\Dev\EMMMNEW\.docs\requirements\req-39-folder-collision.md` |
| AC-39.2.4 (UUID fallback suffix)                 | TC-39-007         | `e:\Dev\EMMMNEW\.docs\requirements\req-39-folder-collision.md` |
| AC-39.2.5 (Dialog cancel)                        | TC-39-008         | `e:\Dev\EMMMNEW\.docs\requirements\req-39-folder-collision.md` |
| Implied: Replace strategy with Trash unavailable | TC-39-009         | `e:\Dev\EMMMNEW\.docs\requirements\req-39-folder-collision.md` |
...
- **DB State**:`emmm.db` with both conflicting folders indexed
