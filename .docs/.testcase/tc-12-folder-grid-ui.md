...
**Requirement File**:`e:\Dev\EMMMNEW\.docs\requirements\req-12-folder-grid-ui.md`
...
- **FileSystem Data**: -`ContainerFolder` x2 -`ModPackRoot` x1001 (for virtualizer stretch test) -`VariantContainer` x1 (for modal popping)
