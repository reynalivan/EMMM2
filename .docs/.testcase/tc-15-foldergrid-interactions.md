...
**Requirement File**:`e:\Dev\EMMMNEW\.docs\requirements\req-15-foldergrid-interactions.md`
...
- **Preconditions**: OS: Windows 10/11. App: EMMM dev build. Mouse + Keyboard setup connected accurately simulating events.
- **Context Injection**: -`mods_path/Characters/Kaeya/` with > 100 entries rendering enabling scrolling behaviors.
