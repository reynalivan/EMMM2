...
**Requirement File**:`e:\Dev\EMMMNEW\.docs\requirements\req-21-mod-rename.md`
...
- **Preconditions**: OS: Windows 10/11. App: EMMM dev build. File Watcher fully active. Conflict resolver mounted.
- **Context Injection**:
