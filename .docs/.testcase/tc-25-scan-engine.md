...
**Requirement File**:`e:\Dev\EMMMNEW\.docs\requirements\req-25-scan-engine.md`
...
- **Preconditions**: OS: Windows 10/11. App: EMMM dev build. Benchmark directory injected.
- **Context Injection**: -`mods_path` containing exactly 1,000 folders to validate speed.
