...
| :------------------------------- | :---------------- | :---------------------------------------------------------- |
| AC-27.1.1 (Atomic Upsert)        | TC-27-001         | `e:\Dev\EMMMNEW\.docs\requirements\req-27-sync-database.md` |
| AC-27.1.2 (BLAKE3 Move Logic)    | TC-27-002         | `e:\Dev\EMMMNEW\.docs\requirements\req-27-sync-database.md` |
| AC-27.1.3 (Transaction Rollback) | TC-27-003         | `e:\Dev\EMMMNEW\.docs\requirements\req-27-sync-database.md` |
| AC-27.1.4 (Auto-Create Object)   | TC-27-004         | `e:\Dev\EMMMNEW\.docs\requirements\req-27-sync-database.md` |
| AC-27.2.1 (Orphan Delete)        | TC-27-005         | `e:\Dev\EMMMNEW\.docs\requirements\req-27-sync-database.md` |
| AC-27.2.2 (Toast Summary)        | TC-27-006         | `e:\Dev\EMMMNEW\.docs\requirements\req-27-sync-database.md` |
| AC-27.2.3 (Slow Disk Timeout)    | TC-27-007         | `e:\Dev\EMMMNEW\.docs\requirements\req-27-sync-database.md` |
