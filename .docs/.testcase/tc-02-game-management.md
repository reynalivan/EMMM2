...
**Requirement File**:`e:\Dev\EMMMNEW\.docs\requirements\req-02-game-management.md`
...
| TC-02-15 | Launch auto-closes app                       | Positive | Med      | Valid paths config         | 1. Toggle`auto_close_on_launch = true`.<br>2. Click 'Play'.                                                           | EMMM terminates gracefully within 2s of successful launch.                                                                   | S3               | AC-02.4.2            |
...
| TC-02-18 | Mod loader hangs UAC                         | Edge     | Med      | Process wait               | 1. Point loader to exe requiring UAC prompt.<br>2. Click 'Play'.<br>3. Look at main EMMM UI.                          | UI thread remains active and unblocked because spawning happens async in Tokio.                                              | S3               | AC-02.4.6            |
