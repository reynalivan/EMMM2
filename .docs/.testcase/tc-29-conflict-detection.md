...
- **Acceptance Criteria**: -`DuplicateInfo` returns during duplicate toggling per Object (< 50ms). -`ConflictResolveDialog` prompts users to 'Enable Only This'.
...
| :-------------------------------------- | :---------------- | :--------------------------------------------------------------- |
| AC-29.1.1 (Duplicate check hit)         | TC-29-001         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
| AC-29.1.2 (Conflict Resolve Modal)      | TC-29-002         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
| AC-29.1.3 ("Enable Anyway" bypass)      | TC-29-003         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
| AC-29.1.4 (Atomic disable multi)        | TC-29-004         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
| AC-29.2.1 (Context -> Enable Only This) | TC-29-005         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
| AC-29.2.2 (UI Cache updates)            | TC-29-006         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
| AC-29.2.3 (No-op trigger)               | TC-29-007         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
| AC-29.3.1 (Global Hash Scan)            | TC-29-008         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
| AC-29.3.2 (Hash Collision View)         | TC-29-009         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
| AC-29.3.3 (Clean Hash run)              | TC-29-010         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
| AC-29.3.4 (Malformed INI skip)          | TC-29-011         | `e:\Dev\EMMMNEW\.docs\requirements\req-29-conflict-detection.md` |
