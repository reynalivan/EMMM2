...
Mengubah `.docs` menjadi `docs` bersifat opsional. Secara arsitektur tidak berpengaruh, tetapi folder visible lebih mudah ditemukan developer dan tooling standar.
