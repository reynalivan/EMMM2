import { RefreshCw, Settings, MoreVertical, PanelRightClose, PanelRightOpen } from 'lucide-react';
...
export default function GlobalActions({ launchBar }: { launchBar?: ReactNode }) {
