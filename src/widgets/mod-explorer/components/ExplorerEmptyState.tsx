...
export default function ExplorerEmptyState() {
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center bg-base-100/50 p-8 pt-[calc(var(--workspace-topbar-height)+2rem)] text-center text-base-content/50 select-none">
