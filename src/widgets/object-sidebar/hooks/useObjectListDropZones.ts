...
import type { DragPosition } from '../../../shared/lib/hooks/useFileDrop';
import { classifyDroppedPaths } from '@/shared/lib/dropClassification';
import { validateDropForZone, type DropZone } from '../utils/dropUtils';
