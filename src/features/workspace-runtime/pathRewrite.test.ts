...
describe('rewriteWorkspacePathValue', () => {
  const rewrites = [
    { oldPath: 'E:/Mods/Raiden/SkinA', newPath: 'E:/Mods/Raiden/DISABLED SkinA' },
  ];
  ...
  it('never touches a same-named mod under another object', () => {
    expect(rewriteWorkspacePathValue('E:/Mods/Nahida/SkinA', rewrites)).toBe('E:/Mods/Nahida/SkinA');
