...
export default function DemoTogglePreset() {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-lg font-bold">{t('demo.one_click_presets')}</h3>
        <p className="text-sm text-base-content/60">{t('demo.applied_instantly')}</p>
      </motion.div>
      ...
      <div className="flex w-full max-w-lg items-center justify-between gap-8 mt-12">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <span className="font-semibold text-xs tracking-wider uppercase opacity-70">
            {isOn ? t('demo.preset_on') : t('demo.preset_off')}
          </span>
        </div>
