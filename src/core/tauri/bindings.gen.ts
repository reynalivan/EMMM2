 ...
 */
export type ImportJobDto = { id: string; batch_id: string | null; download_id: string | null; game_id: string | null; archive_path: string; status: string; match_category: string | null; match_entry_key: string | null; match_alias_name: string | null; match_confidence: number | null; match_reason: string | null; placed_path: string | null; error_msg: string | null; is_duplicate: boolean; created_at: string; updated_at: string }
