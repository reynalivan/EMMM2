...
export function BrowserTabContextMenu({
  ...
  return (
    <div data-testid="browser-tab-context-menu" className="w-full max-w-sm">
      <LiquidSurface liquidRole="overlay" className="rounded-box shadow-lg">
        <ul className="menu p-2" role="menu" aria-label={t('tabs.tab_menu')}>
          ...
          <li>
            <button type="button" role="menuitem" onClick={() => runTabAction(onDuplicateTab)}>
              <Copy size={16} />
