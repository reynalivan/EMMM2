...
vi.mock('@/pages/collections/hooks/useCollections', () => ({
  useCollections: (...args: unknown[]) => mockUseCollections(...args),
}));

vi.mock('@/pages/collections/hooks/useCollectionRuntime', () => ({
...
vi.mock('@/pages/collections/components/SaveCollectionModal', () => ({
  SaveCollectionModal: () => null,
}));

vi.mock('@/pages/collections/components/ApplyCollectionModal', () => ({
