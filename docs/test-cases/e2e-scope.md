...
Support bersama: `tests/e2e/support/{fixtures,ipc,app,data}.ts`. Fixture arsip: `tests/e2e/fixtures/sample-mod.zip`. `*` = sebagian [manual-smoke], lihat di bawah.
...
| --------------------------------------------------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| Extract fixture helper bersama (mock game factory, IPC-seed, cleanup) | —            | Refactor dari 2 spec existing → `tests/e2e/support/`. DRY, dipakai semua fase.                                                   |
...
_(tc-24 tidak ada di repo — bukan gap.)_
